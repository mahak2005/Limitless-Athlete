    ...
    <div className="max-w-5xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-600 mb-4">
          Based on your requirements, we've found these perfect matches for your sponsorship campaign
        </p>
      ...
      >
        <p className="text-gray-600 mb-4">Not seeing what you're looking for?</p>
        <div className="flex justify-center gap-4">
